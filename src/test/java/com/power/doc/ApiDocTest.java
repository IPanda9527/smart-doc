...
public class ApiDocTest {
    ...
    public void testBuilderControllersApi() {
        ...
        // dsf注解扫描
        config.setDsf(true);
        config.setOutPath("/Users/hujiabin/project/ly/tc-flight-marketingcore/app/test/src/main/doc");
        config.setMd5EncryptedHtmlName(true);
        //不指定SourcePaths默认加载代码为项目src/main/java下的
        config.setSourceCodePaths(
                SourceCodePath.path().setDesc("本项目代码").setPath("/Users/hujiabin/project/ly/tc-flight-marketingcore/app/facade/src/main/java/com/ly/flight/marketingcore/facade")
...
//                RevisionLog.getLog().setVersion("1.0.0").setStatus("create").setAuthor("hjb34019")
//        );
